...
tk.Label(root, text="Анкета Web-разработчика",
         font=("Arial", 18, "bold"), bg=BG).pack(anchor="w", padx=10, pady=(10, 6))
...
rf = make_cell(frame, 0, 1, "white", ipadx=4, ipady=4)
...
rf = make_cell(frame, 2, 1, "white", ipadx=4, ipady=4)
...
rf = make_cell(frame, 3, 1, "white", ipadx=4, ipady=4)
gender_var = tk.StringVar(value="М")
g_frame = tk.Frame(rf, bg="white")
...
rf = make_cell(frame, 4, 1, "white", ipadx=4, ipady=4)
skills = [
...
for s in skills:
    v = tk.BooleanVar()
    skill_vars.append(v)
    tk.Checkbutton(rf, text=s, variable=v, bg="white",
